                ...
                <form method="POST" action="{{ route('categories.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center gap-3">
                            <input type="color" id="color" name="color" value="{{ old('color', '#6366f1') }}" class="h-10 w-14 p-1 rounded border border-gray-300 cursor-pointer" required>
                    ...
                    <div class="flex items-center gap-4">
                        <x-primary-button>{{ __('Salva Categoria') }}</x-primary-button>
