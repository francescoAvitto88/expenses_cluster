...
class ExpensePolicy
{
    ...
    public function restore(User $user, Expense $expense): bool { return $user->id === $expense->user_id; }
    public function forceDelete(User $user, Expense $expense): bool { return $user->id === $expense->user_id; }
}
